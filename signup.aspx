    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <asp:RequiredFieldValidator ID="valreq1" runat="server" ControlToValidate="txtLname" ErrorMessage="Last Name is Missing!!"></asp:RequiredFieldValidator>
                </td>
                <td>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtLname" ErrorMessage="Invalid Lname name format!!" ValidationExpression="([A-Z][a-z]*\s[A-Z][a-z]*)|([A-Z][a-z]*)"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style11">
                    <asp:RequiredFieldValidator ID="valreq2" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email Address is Missing!!"></asp:RequiredFieldValidator>
                </td>
                <td class="auto-style9">
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtPhone" ErrorMessage="RegularExpressionValidator" ValidationExpression="[0][1][0-2][0-24-9]\s\d{7}"></asp:RegularExpressionValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <asp:RequiredFieldValidator ID="valreq3" runat="server" ControlToValidate="txtUsername" ErrorMessage="Username is Missing!!"></asp:RequiredFieldValidator>
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="auto-style8">
                    <asp:RequiredFieldValidator ID="valreq4" runat="server" ControlToValidate="txtPassword" ErrorMessage="Password is Missing"></asp:RequiredFieldValidator>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassword" ControlToValidate="RetypePass" ErrorMessage="No Matching, Please, Reenter!!"></asp:CompareValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
